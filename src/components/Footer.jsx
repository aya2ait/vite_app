...
const Footer = () => {
  return (
    <footer className="bg-[linear-gradient(to_right,_#2e2e2e,_#1c1c1c,_#000000)] backdrop-blur-xl border-t border-gray-700/50 py-12 text-gray-100">
